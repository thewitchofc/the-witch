...
function WhatsAppIcon() {
  return (
    <svg
      ...
      width={26}
      height={26}
      className="whatsapp-widget-icon shrink-0"
      aria-hidden
    >
      <path
        fill="#fff"
...
/** כפתור וואטסאפ צף — פינה ימנית תחתונה, אייקון סטנדרטי */
  ...
  return (
    ...
    >
      <a
        ...
        className="whatsapp-widget-btn pointer-events-auto inline-flex h-11 w-11 items-center justify-center rounded-full bg-[#25D366] text-white no-underline shadow-[0_3px_12px_rgba(0,0,0,0.2)] ring-1 ring-black/10 transition visited:text-white hover:scale-105 hover:bg-[#20bd5a] hover:text-white hover:shadow-[0_4px_16px_rgba(37,211,102,0.4)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#25D366]/90"
        aria-label="שליחת הודעה בוואטסאפ (נפתח בחלון חדש)"
        onClick={() => trackCtaClick('whatsapp_float', href)}
      >
        <WhatsAppIcon />
      </a>
    </div>
